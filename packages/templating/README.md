...
LWR supports the configuration of content and layout templates for each [route](https://github.com/salesforce/lwr-recipes/blob/master/doc/config.md#routes) in an application. LWR renders the response for a page request given the current [route templates](#templates) and [context](#context).
...
-   [Asset](https://github.com/salesforce/lwr-recipes/blob/master/doc/config.md#assets) References
...
Most templating configuration takes place in the routes. See the examples above and the [route](https://github.com/salesforce/lwr-recipes/blob/master/doc/config.md#routes) and [error route](https://github.com/salesforce/lwr-recipes/blob/master/doc/config.md#error-routes) configuration documentation.
...
> See additional information on [directory configuration](https://github.com/salesforce/lwr-recipes/blob/master/doc/config.md#more-configuration) and [assets](https://github.com/salesforce/lwr-recipes/blob/master/doc/config.md#assets).

#### Hooks

**Warning**: This is an advanced topic.

You can write code that dynamically updates the [configuration](https://github.com/salesforce/lwr-recipes/blob/master/doc/config.md#configuration) and [global data](#global-data) for an application upon startup. The locations of configuration hooks are set like this:
